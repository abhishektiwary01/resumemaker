...
function Templetes(props) {
  ...
  return (
    <>
      ...
      <Header />
      <h1 className="mt-8 ml-44 font-bold text-3xl text-center md:text-5xl md:text-left">
      Templates
      </h1>
      <p className="mt-4 ml-44 font-bold text-xl text-center md:text-2xl md:text-left">
      Pick your Template
      </p>
